...
<svg id="Group_2" data-name="Group 2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1366 769">
  <defs>
      ...
      <div class="modal-wrapper">
        ...
        <div class="modal-body ">
            ...
            <div class="bg-light p-3 rounded">
              ...
              <input type="text" class="form-control" v-model="StartTimes"><br>
              <input type="time" class="form-control" v-model="StartTimes">
            </div><br>
            ...
            <div class="modal-footer">
                ...
                <div class="deletebooking" @click="deleteevent">Delete</div>
            </div>
