...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="100%" width="100%" viewBox="0 0 1370.134 792">
  <defs>
...
<table>
    <tr>
        ...
        <th>StartTime</th>
        <th>Duration</th>
        <th style="background-color: rgb(205, 133, 219);">Info</th>
    </tr>
    ...
    <tr v-for="(event ,index ) in data" :key="index">
        ...
        <td>
            <img src="../assets/information.png" id="info" @click="editevent">
        </td>
    </tr>
</table>
